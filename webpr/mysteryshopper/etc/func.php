        ...
        while ($rw[$i-1] != "") {
          ...
          $i++;
            ...
            if($fecha <= $fechaactual){
                echo "</tbody></table><input type='submit' class='btn-block' name='enviarPV' value='Enviar Respuestas'></input>";
            } else{
...
function listarVisitas($iduser){
    ...
    if ($match1 > 0) {
        ...
        echo "No hay visitas programadas en este momento.";
    }
}
    ...
    if ($match > 0) {
        while ($rw = mysqli_fetch_array($search)) {
            ...
            echo "  <br><div class='form-group'><label class='control-label col-sm-5'>Fecha Programada:</label><div class='col-sm-5'><input type='text' class='form-control' name='fecha' value='$fecha' readonly></div></div>
                    ...
                    <br><div class='form-group'><label class='control-label col-sm-5'>Instrucciones:</label><div class='col-sm-5'><input type='text' class='form-control' name='vis_obser' value='$vis_obser' readonly></div></div>
